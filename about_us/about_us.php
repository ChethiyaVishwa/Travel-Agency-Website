...
<head>
    ...
    <title>About Us - Adventure Travel</title>
    ...
    <section class="about-section">
        <div class="container">
            <div class="about-header">
                <h1><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;">About</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">Adventure Travel</span></h1>
            </div>
            
            <div class="about-content">
                <p>Welcome to Adventure Travel, your premier travel partner in Sri Lanka. We specialize in creating unforgettable travel experiences that showcase the beauty and culture of our island nation.</p>
