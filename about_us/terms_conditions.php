...
<head>
    ...
    <title>Terms and Conditions - Adventure Travel</title>
    ...
    <section class="policy-section">
        <div class="container">
            <div class="policy-header">
                <h1><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;"><?php echo isset($policy['policy_title']) ? explode(' ', htmlspecialchars($policy['policy_title']), 2)[0] : 'Terms'; ?></em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;"><?php echo isset($policy['policy_title']) ? (count(explode(' ', htmlspecialchars($policy['policy_title']))) > 1 ? explode(' ', htmlspecialchars($policy['policy_title']), 2)[1] : '') : 'and Conditions'; ?></span></h1>
            </div>
            ...
            <div class="policy-content">
                ...
                <?php if (count($sections) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Detailed terms and conditions are being updated. Please check back later.</p>
                <?php endif; ?>
