...
<head>
    ...
    <title>Refund Policy - Adventure Travel</title>
    ...
    <style>
        ...
        * {
        ...
        .dark-mode {
            ...
            --secondary-color: linear-gradient(to right,rgb(0, 205, 164) 0%,rgb(0, 9, 8) 100%);o right,rgb(0, 205, 164) 0%,rgb(0, 9, 8) 100%);
            --dark-color: #f0f0f0;
            --light-color: #222;
        ...
        <div class="container">
            ...
            <div class="policy-content">
                ...
                <?php if (count($sections) > 0): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>Detailed refund policy is being updated. Please check back later.</p>
                <?php endif; ?>
