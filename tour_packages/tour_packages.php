...
// Get all tour packages (type_id = 1)
...
$featured_query = "SELECT p.* 
                  FROM packages p 
                  WHERE p.type_id = 1 AND p.featured = 1
...
<head>
    ...
    <title>Tour Packages - Adventure Travel</title>
...
<body>
    ...
    <?php else: ?>
    <section class="hero" style="background-image: url('../images/tourpackage.png');">
        <a href="../index.php" class="back-to-home"> Back to Home </a>
        <div class="hero-content">
            <h1><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-weight: bold;">Exclusive</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">Tour Packages</span></h1>
            <p><span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: 900; text-shadow: 1px 1px 3px rgba(0,0,0,0.3);">Experience the beauty, culture, and adventure on a multi-day tour</span></p>
            <a href="#tour-packages" class="btn">View Tours</a>
        </div>
    </section>
    <?php endif; ?>

    <section id="tour-packages" class="section">
        <div class="container">
            <div class="section-title">
                <h2><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;">Our</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">Tour Packages</span></h2>
                <p>Discover Sri Lanka with our carefully curated multi-day tour packages</p>
            </div>
            ...
            <div class="packages">
                ...
                <?php
                    ...
                    echo '<p class="no-packages">No tour packages available at the moment.</p>';
                }
                ?>
            </div>
        </div>
    ...
    <section id="sri-lanka-map-section" class="section">
        <div class="container">
            <div class="section-title">
                <h2><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;">Explore Our</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">Tour Locations</span></h2>
                <p>Interactive map of our tour destinations across beautiful Sri Lanka</p>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add destinations manually for tour packages
            const destinations = [
            ...
            destinations.forEach(dest => {
                ...
                markers.push(dest.coords);
            });
            
            // Draw a smooth curved line connecting major destinations
            // Create a path that traverses through main tour locations
            const mainPath = [
                [6.9271, 79.8612], // Colombo
                [7.2906, 80.6337], // Kandy
                [7.8675, 80.6491], // Dambulla
                [7.9570, 80.7603], // Sigiriya
                [7.9403, 81.0188], // Polonnaruwa
                [6.9497, 80.7891], // Nuwara Eliya
                [6.8667, 81.0466], // Ella
                [6.0535, 80.2210], // Galle
                [6.9271, 79.8612]  // Back to Colombo
            ];
