...
EOT;
    ...
    public function testAttachmentNaming()
    {
        ...
        $this->Mail->addAttachment(
            realpath(\PHPMAILER_INCLUDE_DIR . '/examples/images/PHPMailer card logo-5.PNG'),
            'PHPMailer card logo-5.PNG'
        );
        $this->Mail->addAttachment(
            realpath(\PHPMAILER_INCLUDE_DIR . '/examples/images/phpmailer_mini.png'),
            'phpmailer_mini.png\\\";.jpg'
        ...
        self::assertStringContainsString(
            'Content-Type: image/png; name="PHPMailer card logo-5.PNG"',
            $message,
            'Name with spaces should be quoted in Content-Type'
        );
        self::assertStringContainsString(
            'Content-Disposition: attachment; filename="PHPMailer card logo-5.PNG"',
            $message,
