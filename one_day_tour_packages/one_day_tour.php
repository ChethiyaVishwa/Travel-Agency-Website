...
<head>
    ...
    <title>One Day Tours - Adventure Travel</title>
...
<body>
    ...
    <?php else: ?>
    <section class="hero" style="background-image: url('../images/oneday.png');">
        <a href="../index.php" class="back-to-home"> Back to Home </a>
        <div class="hero-content">
            <h1><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-weight: bold;">Exclusive</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">One Day Tours</span></h1>
            <p><span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: 900; text-shadow: 1px 1px 3px rgba(0,0,0,0.3);">Exciting one-day excursions packed with adventure and culture</span></p>
            <a href="#one-day-tours" class="btn">View One Day Tours</a>
        </div>
    </section>
    <?php endif; ?>
    ...
    <section id="one-day-tours" class="section">
        <div class="container">
            <div class="section-title">
                <h2><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;">Our</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">One Day Tours</span></h2>
    ...
    <section id="sri-lanka-map-section" class="section">
        <div class="container">
            <div class="section-title">
                <h2><em style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-size: 1.1em; font-weight: bold;">One Day</em> <span style="font-family: 'Dancing Script', 'Segoe Script', 'Lucida Handwriting', 'Brush Script MT', cursive; font-style: italic; font-weight: bold;">Tour Locations</span></h2>
